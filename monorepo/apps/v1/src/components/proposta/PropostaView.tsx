          ...
          <div className="proposal-loader__lockup">
            ...
            <div className="proposal-loader__brand proposal-loader__brand--client">
              {p.cliente.logoUrl ? (
                // eslint-disable-next-line @next/next/no-img-element
                <img
                  src={p.cliente.logoUrl}
                  alt={p.cliente.nome}
                  className="proposal-loader__logo"
                  style={p.cliente.logoBg ? { background: p.cliente.logoBg, padding: "0.5rem 1rem" } : undefined}
                />
              ) : (
                <div
                  className="proposal-loader__logo proposal-loader__monogram"
                  aria-label={p.cliente.nome}
                >
